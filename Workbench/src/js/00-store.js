...
function seedWorks() {
  ...
  return [
    ...
    { id: uid(), name: '口袋卡牌助手小程序', type: '小程序', cat: '案例', status: '已上线', url: 'https://github.com/juziqishui11/Workbuddy_Place', github: R + '/toy-collection-mp', online: W.toycol, desc: '微信原生小程序：宝可梦卡牌收藏与开包模拟，关都 151 图鉴、本地存储、持有进度/估值/心愿单；开包抽到的卡自动点亮收藏册（传说/幻之稀有掉落）。', tags: ['小程序', '宝可梦', '卡牌', '开包'], createdAt: iso, updatedAt: iso },
