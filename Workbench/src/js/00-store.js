...
function seedWorks() {
  ...
  return [
    ...
    { id: uid(), name: '口袋卡牌助手小程序', type: '小程序', cat: '案例', status: '已上线', url: 'https://github.com/juziqishui11/Workbuddy_Place', github: R + '/toy-collection-mp', online: W.toycol, desc: '微信原生小程序：宝可梦卡牌收藏与开包模拟，全国图鉴前五代 649 只（关都/城都/丰缘/神奥/合众），卡面采用官方 TCG 卡图，本地存储、持有进度/估值/心愿单；开包可限定系列，抽到的卡自动点亮收藏册（传说/幻之稀有掉落）。', tags: ['小程序', '宝可梦', '卡牌', 'TCG', '开包'], createdAt: iso, updatedAt: iso },
